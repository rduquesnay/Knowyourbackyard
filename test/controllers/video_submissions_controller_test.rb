...
class VideoSubmissionsControllerTest < ActionController::TestCase
  ...
  test "should create video_submission" do
    assert_difference('VideoSubmission.count') do
      post :create, video_submission: { about: @video_submission.about, demo_link: @video_submission.demo_link, trail_id: @video_submission.trail_id }
    end
  ...
  test "should update video_submission" do
    patch :update, id: @video_submission, video_submission: { about: @video_submission.about, demo_link: @video_submission.demo_link, trail_id: @video_submission.trail_id }
    assert_redirected_to video_submission_path(assigns(:video_submission))
  end
